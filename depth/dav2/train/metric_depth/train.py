# Local
from dataset.terra import Terra
...
parser.add_argument('--dataset', default='terra', choices=['terra'])
parser.add_argument('--dataset-path', type=str, required=True)
parser.add_argument('--img-size', default=518, type=int)
parser.add_argument('--min-depth', default=0.2, type=float)
...
def main():
    ...
    if args.dataset == 'terra':
        trainset = Terra(args.dataset_path, 'train', size=size)
    else:
    ...
    if args.dataset == 'terra':
        valset = Terra(args.dataset_path, 'val', size=size)
    else:
        raise NotImplementedError
